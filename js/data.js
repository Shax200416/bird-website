const birds = [
{
  ...
  audio: "/audio/Домовый воробей.mp3",
  diet: ["omnivore"],
  habitat: ["urban","rural"],
...
},
{
 ...
 images:[
  ...
  description: {
    ...
    kg: "Түнкү бүркүт — түнкү жырткыч канаттуу, чоң көздөрү, үндү жок кылган учу жана мыкты угуу жөндөмү менен белгилүү. Негизинен чакан жаныбарлар, канаттуулар, курт-кумурскалар жана кээде балыктар менен азыктанат. Бүркүт ар түрдүү чөйрөлөрдө жашайт — токойлор, талаалар, чөлдөр жана шаарлар, көбүнчө дарак тешиктеринде, жээктерде же сарайларда уя курат. Жалгыз жана аймактык, түнү кыңгырактар менен байланышат. 2–12 жумуртка салат, түрүнө жараша, көптөгөн маданияттарда акылдын символу деп эсептелет."
  },
  images:[
    "img/image6.png",
    "img/image6.1.png",
...
},
{
  ...
  audio: "/audio/hummingbird.mp3",
  diet: ["Nectarivore"],
  habitat: ["forests", "gardens"],
  description: {
    en: "Hummingbirds are the smallest birds in the world, known for their incredibly fast wingbeats — up to 80 times per second. They feed mainly on flower nectar using their long, tube-like beaks and tongues. Hummingbirds can hover in mid-air and even fly backwards. They are found only in the Americas and build tiny cup-shaped nests, usually laying 2 eggs.",
    ru: "Колибри — самые маленькие птицы в мире. Их крылья совершают до 80 взмахов в секунду, что позволяет им зависать в воздухе. Питаются нектаром цветов с помощью длинного клюва. Встречаются только на американском континенте и строят крошечные гнёзда, откладывая обычно 2 яйца.",
    kg: "Колибри — дүйнөдөгү эң кичине куш. Канаттары секундасына 80 жолу сермелет, бул аларга абада туруп калууга мүмкүндүк берет. Узун тумшугу аркылуу гүлдөрдүн нектары менен азыктанат. Алар Америкада гана жашайт жана кичинекей уя куруп, адатта 2 жумуртка тууйт."
  },
  images: [
    "img/image21.png",
    "img/image21.1.png",
